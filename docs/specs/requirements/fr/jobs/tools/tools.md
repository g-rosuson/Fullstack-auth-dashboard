...
Job tools and their required inputs.

- **FR-JOBS-TLR-001** — A job shall include at least one tool.
- **FR-JOBS-TLR-002** — The system shall support scraper and email tools.
- **FR-JOBS-TLR-003** — A scraper shall have at least one keyword, provided on the tool or on a target. Target keywords override tool keywords.
