...
Functional requirements for titled surfaces, actions, forms, date controls, action menus, user identity, tabular listings, tabbed surfaces, navigation listings, confirmation prompts, and brief notifications.
...
Acceptance (not FRs): [Client](../../../architecture/client/ui/index.md).
