...
export enum ErrorMessage {
    ...
    JOBS_NOT_FOUND_IN_DATABASE = 'Job not found in database',
    JOBS_NOT_FOUND_IN_MEMORY = 'Job not found in memory',
    JOBS_START_DATE_MUST_BE_IN_THE_FUTURE = 'Start date must be in the future',
    JOBS_END_DATE_MUST_BE_IN_THE_FUTURE = 'End date must be in the future',
    JOBS_START_DATE_MUST_COME_BEFORE_END_DATE = 'Start date must come before end date',
    ...
    JOBS_CANNOT_CHANGE_STATUS_WHILE_RUNNING = 'Cannot change the schedule status of a job while it is running',
    JOBS_CANNOT_CHANGE_STATUS_WITHOUT_SCHEDULE = 'Cannot change the status of a job without a schedule',
    JOBS_CANNOT_CHANGE_STATUS_TO_EXISTING_STATUS = 'Cannot change the schedule status to an existing status',
    JOBS_CANNOT_CHANGE_STATUS_OF_EXPIRED_SCHEDULE = 'Cannot change the schedule status to idle for a job whose schedule has ended',
