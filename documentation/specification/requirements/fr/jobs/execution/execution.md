...
- **FR-JOBS-STR-001** — The system shall provide a live stream of job activity, including which jobs are running and when targets finish, the job finishes, or the job fails.
